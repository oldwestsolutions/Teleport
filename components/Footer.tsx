  ...
  return (
    <footer id="footer" className="relative border-t border-white/10 bg-black/40 px-6 py-14 backdrop-blur-sm">
      ...
      <div className="relative mx-auto grid max-w-6xl gap-10 text-sm text-white/55 md:grid-cols-12">
        <div className="md:col-span-5">
          ...
          <p className="mt-3 max-w-md leading-relaxed">
            An Old West Solutions integrated communication network where access is powered by BELL staking.
            Secure messaging, private email, and network routing are activated through stake-based participation
            and available across Old West ecosystem integrations.
          </p>
        </div>
        <div className="md:col-span-3">
          ...
          <ul className="mt-3 space-y-2">
            ...
            <li><a href="#" className="transition hover:text-white">Staking Model</a></li>
            <li><a href="#" className="transition hover:text-white">Security + Privacy</a></li>
          </ul>
        </div>
        <div className="md:col-span-2">
          <p className="text-xs uppercase tracking-[0.18em] text-white/45">Company</p>
          <ul className="mt-3 space-y-2">
            <li><a href="https://oldwest.net" className="transition hover:text-white">Old West Solutions</a></li>
      ...
      <div className="relative mx-auto mt-10 flex max-w-6xl flex-col gap-2 border-t border-white/10 pt-6 text-xs text-white/45 sm:flex-row sm:items-center sm:justify-between">
        ...
        <p>Teleport — The Network Where Access is Earned.</p>
      </div>
    </footer>
  );
}
